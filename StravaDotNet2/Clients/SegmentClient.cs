...
namespace Strava.Clients
{
    ...
    public class SegmentClient : BaseClient
    {
        ...
        /// <param name="running">True returns run segments, false returns ride segments.</param>
        ...
        public async Task<ExplorerResult> ExploreSegmentsAsync(Coordinate southWest, Coordinate northEast, bool running)
        {
            ...
            string activityType = string.Format("activity_type={0}", running ? "running" : "riding");
            string getUrl = string.Format("{0}/explore?bounds={1}&access_token={2}&{3}",
                Endpoints.Leaderboard,
                bnds,
                Authentication.AccessToken,
                activityType);
        ...
        /// <returns>Up to ten segments within the boundary box. When there are more than ten segments, the ten most 
        /// popular ones will be returned.</returns>
        public async Task<ExplorerResult> ExploreSegmentsAsync(Coordinate southWest, Coordinate northEast, bool running, int minCat, int maxCat)
        {
            string bnds = string.Format("{0},{1},{2},{3}",
                southWest.Latitude.ToString(CultureInfo.InvariantCulture),
                southWest.Longitude.ToString(CultureInfo.InvariantCulture),
            ...
            string activityType = string.Format("activity_type={0}", running ? "running" : "riding");
            string getUrl = string.Format("{0}/explore?bounds={1}&min_cat={2}&max_cat={3}&access_token={4}&{5]",
                Endpoints.Leaderboard,
                bnds,
                minCat,
                maxCat,
        ...
        /// <returns>Up to ten segments within the boundary box. When there are more than ten segments, the ten most 
        /// popular ones will be returned.</returns>
        public ExplorerResult ExploreSegments(Coordinate southWest, Coordinate northEast, bool running)
        {
            string bnds = string.Format("{0},{1},{2},{3}",
                southWest.Latitude.ToString(CultureInfo.InvariantCulture),
                southWest.Longitude.ToString(CultureInfo.InvariantCulture),
            ...
            string activityType = string.Format("activity_type={0}", running ? "running" : "riding");
            string getUrl = string.Format("{0}/explore?bounds={1}&access_token={2}&{3}", Endpoints.Leaderboard, bnds, Authentication.AccessToken, activityType);
            string json = WebRequest.SendGet(new Uri(getUrl));
        ...
        /// <returns>Up to ten segments within the boundary box. When there are more than ten segments, the ten most 
        /// popular ones will be returned.</returns>
        public ExplorerResult ExploreSegments(Coordinate southWest, Coordinate northEast, bool running, int minCat, int maxCat)
        {
            string bnds = string.Format("{0},{1},{2},{3}",
                southWest.Latitude.ToString(CultureInfo.InvariantCulture),
                southWest.Longitude.ToString(CultureInfo.InvariantCulture),
            ...
            string activityType = string.Format("activity_type={0}", running ? "running" : "riding");
            string getUrl = string.Format("{0}/explore?bounds={1}&min_cat={2}&max_cat={3}&access_token={4}&{5}",
                Endpoints.Leaderboard, bnds, minCat, maxCat, Authentication.AccessToken, activityType);
            string json = WebRequest.SendGet(new Uri(getUrl));
